...
export const Tile = {
  read(pbf, end) {
    const obj = { layers: [] };
    pbf.readFields(Tile._readField, obj, end);
    return obj;
  },
...
Tile.Value = {
  read(pbf, end) {
    ...
    pbf.readFields(Tile.Value._readField, obj, end);
    return obj;
  },
...
Tile.Feature = {
  read(pbf, end) {
    ...
    pbf.readFields(Tile.Feature._readField, obj, end);
    return obj;
  },
...
Tile.Layer = {
  read(pbf, end) {
    ...
    pbf.readFields(Tile.Layer._readField, obj, end);
    return obj;
  },
